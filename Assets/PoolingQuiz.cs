...
public class PoolingQuiz : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        switch (poolType)
        {
            case 3:
                ...
                transform.Find("OutputSnapZone11").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap2.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone12").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap3.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone13").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap4.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone21").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap5.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone22").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap6.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone23").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap7.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone31").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap8.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone32").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());

                snapValue = snap9.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone33").Find("Text").GetComponent<TextMeshPro>().SetText(minPool(snapValue).ToString());
            ...
            case 2:
                ...
                snapValue = snap1.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone11").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap2.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone12").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap3.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone13").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap4.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone21").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap5.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone22").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap6.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone23").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap7.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone31").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap8.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone32").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());

                snapValue = snap9.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone33").Find("Text").GetComponent<TextMeshPro>().SetText(avgPool(snapValue).ToString());
                break;
            case 1:
                cubeValue = cube1.GetComponent<FilterInput>().getInputValue();

                snapValue = snap1.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone11").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap2.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone12").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap3.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone13").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap4.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone21").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap5.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone22").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap6.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone23").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap7.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone31").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap8.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone32").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());

                snapValue = snap9.GetComponent<SnapZoneInput3x3>().getInputValue();
                transform.Find("OutputSnapZone33").Find("Text").GetComponent<TextMeshPro>().SetText(maxPool(snapValue).ToString());
                break;
        }
